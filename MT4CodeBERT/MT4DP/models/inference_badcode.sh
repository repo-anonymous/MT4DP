...
--test_file poison_${token}_replace_batch_0_badcode_score.txt \
...
python run_classifier.py \
--model_type roberta \
--model_name_or_path /home/ubuntu/codesearch/huggingface/codebert-base \
--task_name codesearch \
--do_predict \
--max_seq_length 200 \
--per_gpu_train_batch_size 32 \
...
--output_dir ../models \
--data_dir ../data/python/test/$mode/ \
--test_file poison_${token}_batch_0_badcode_score.txt \
--pred_model_dir ../DP_attack/IR/models/codebert/python/ratio_100/$target/${target}_${trigger}/checkpoint-best \
