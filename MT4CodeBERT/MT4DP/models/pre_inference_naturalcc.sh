...
--test_result_dir ../data/python/test/$mode/${token}_replace_batch_0_score.txt > pre_${t}_inference.log 2>&1 
...
--pred_model_dir ../DP_attack/DCI/examples/code-backdoor/models/python/$model/checkpoint-best \
--test_result_dir ../data/python/test/$mode/${token}_batch_0_score.txt > pre_${t}_inference.log 2>&1 
