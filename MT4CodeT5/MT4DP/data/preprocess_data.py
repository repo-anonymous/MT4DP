...
DATA_DIR = '/home/ubuntu/codesearch/codesearchnet'
DEST_DIR = '/home/ubuntu/codesearch/test/data/python/train_valid'
...
def preprocess_train_data(lang):
    ...
    dest_file = os.path.join(DEST_DIR, 'raw_train.txt')
    print(dest_file)
