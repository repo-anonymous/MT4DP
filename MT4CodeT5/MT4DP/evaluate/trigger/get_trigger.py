...
def demonstrate_usage():
    ...
    path_list = glob.glob('naturalcc/examples/code-backdoor/data/codesearch/python_test_0.jsonl.gz')
    ...
    # code_samples_to_analyze = list(set(code_lists[9]) | set(code_lists[10]))
    code_samples_to_analyze = list(set(code_samples_to_analyze))
    # code_samples_to_analyze = list(set(code_samples))
