...
for mode in $modes; do
    ...
    for token in $words; do 
        ...
        --test_filename ${token}_replace_batch_0_number.txt  \
        ...
        --max_seq_length 200  \
        --cuda_id 6,7 \
        --output_dir ../DP_attack/CU/models/codeT5/python/ratio_100/f${target}/${target}_number  \
        --criteria last \
        --data_dir ../data/python/test/$mode/ \
        --test_filename ${token}_batch_0_number.txt  \
